...
//        shop2.setLocation_y((float)0.535764663035046);
        ...
        RestaurantEntity shop4 = new RestaurantEntity();
        shop4.setName("顶屋咖喱");
        shop4.setImages("352");
        shop4.setLocation_x((float)0.373000);
        shop4.setLocation_y((float)0.533000);
        shop4.setAveragePrice(shop0.getAveragePrice());
        shop4.setContactinfo(shop0.getContactinfo());
        shop4.setId(5);
        shop4.setBusinessHours("18:00:00:00");
        shop4.setDishList(shop0.getDishList());
        shop4.setLocation(shop0.getLocation());
        shop4.setReviewList(shop0.getReviewList());
        shop4.setRating(shop0.getRating());
        shop4.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop4);

        RestaurantEntity shop5 = new RestaurantEntity();
        shop5.setName("沙县小吃");
        shop5.setImages("352");
        shop5.setLocation_x((float)0.351000);
        shop5.setLocation_y((float)0.542000);
        shop5.setAveragePrice(shop0.getAveragePrice());
        shop5.setContactinfo(shop0.getContactinfo());
        shop5.setId(6);
        shop5.setBusinessHours("14:00:32:00");
        shop5.setDishList(shop0.getDishList());
        shop5.setLocation(shop0.getLocation());
        shop5.setReviewList(shop0.getReviewList());
        shop5.setRating(shop0.getRating());
        shop5.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop5);

        RestaurantEntity shop6 = new RestaurantEntity();
        shop6.setName("小伙计肉夹馍");
        shop6.setImages("352");
        shop6.setLocation_x((float)0.350000);
        shop6.setLocation_y((float)0.539000);
        shop6.setAveragePrice(shop0.getAveragePrice());
        shop6.setContactinfo(shop0.getContactinfo());
        shop6.setId(7);
        shop6.setBusinessHours("14:00:32:00");
        shop6.setDishList(shop0.getDishList());
        shop6.setLocation(shop0.getLocation());
        shop6.setReviewList(shop0.getReviewList());
        shop6.setRating(shop0.getRating());
        shop6.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop6);

        RestaurantEntity shop7 = new RestaurantEntity();
        shop7.setName("张亮麻辣烫");
        shop7.setImages("352");
        shop7.setLocation_x((float)0.348000);
        shop7.setLocation_y((float)0.535000);
        shop7.setAveragePrice(shop0.getAveragePrice());
        shop7.setContactinfo(shop0.getContactinfo());
        shop7.setId(8);
        shop7.setBusinessHours("12:00:10:00");
        shop7.setDishList(shop0.getDishList());
        shop7.setLocation(shop0.getLocation());
        shop7.setReviewList(shop0.getReviewList());
        shop7.setRating(shop0.getRating());
        shop7.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop7);

        RestaurantEntity shop8 = new RestaurantEntity();
        shop8.setName("杨国福麻辣烫");
        shop8.setImages("352");
        shop8.setLocation_x((float)0.346000);
        shop8.setLocation_y((float)0.534000);
        shop8.setAveragePrice(shop0.getAveragePrice());
        shop8.setContactinfo(shop0.getContactinfo());
        shop8.setId(9);
        shop8.setBusinessHours("12:00:10:00");
        shop8.setDishList(shop0.getDishList());
        shop8.setLocation(shop0.getLocation());
        shop8.setReviewList(shop0.getReviewList());
        shop8.setRating(shop0.getRating());
        shop8.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop8);

        RestaurantEntity shop9 = new RestaurantEntity();
        shop9.setName("呷哺呷哺");
        shop9.setImages("352");
        shop9.setLocation_x((float)0.364000);
        shop9.setLocation_y((float)0.535000);
        shop9.setAveragePrice(shop0.getAveragePrice());
        shop9.setContactinfo(shop0.getContactinfo());
        shop9.setId(10);
        shop9.setBusinessHours("13:00:10:00");
        shop9.setDishList(shop0.getDishList());
        shop9.setLocation(shop0.getLocation());
        shop9.setReviewList(shop0.getReviewList());
        shop9.setRating(shop0.getRating());
        shop9.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop9);

        RestaurantEntity shop10 = new RestaurantEntity();
        shop10.setName("茶颜悦色");
        shop10.setImages("352");
        shop10.setLocation_x((float)0.364000);
        shop10.setLocation_y((float)0.537000);
        shop10.setAveragePrice(shop0.getAveragePrice());
        shop10.setContactinfo(shop0.getContactinfo());
        shop10.setId(11);
        shop10.setBusinessHours("15:00:20:00");
        shop10.setDishList(shop0.getDishList());
        shop10.setLocation(shop0.getLocation());
        shop10.setReviewList(shop0.getReviewList());
        shop10.setRating(shop0.getRating());
        shop10.setStyle(shop0.getStyle());
        RestaurantRepository.save(shop10);
    }
    public String func2(){
